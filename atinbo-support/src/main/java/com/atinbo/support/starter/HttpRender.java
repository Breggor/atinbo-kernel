...
public abstract class HttpRender {
    protected static final Logger logger = LoggerFactory.getLogger(HttpRender.class);
    ...
    public static void flushJson(HttpServletResponse response, Object record) {
        LoggerHelper.pushResponseData(JSON.toJSONString(record, new SerializerFeature[]{SerializerFeature.DisableCircularReferenceDetect}));
