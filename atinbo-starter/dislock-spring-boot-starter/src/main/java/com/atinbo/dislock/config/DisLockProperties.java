...
public class DisLockProperties {
     ...
     * 客户端名称
     */
    private String clientName = DisLockConsts.LOCK;
    /**
     * 启用SSL终端识别
     */
     ...
     */
    private String sslProvider = DisLockConsts.JDK;
    /**
     * SSL信任证书库路径
     */
    ...
    public static class MasterSlaveConfig {
         ...
         * 读取操作的负载均衡模式
         */
        private String readMode = DisLockConsts.SLAVE;
        /**
         * 订阅操作的负载均衡模式
         */
        private String subMode = DisLockConsts.SLAVE;
        /**
         * 负载均衡算法类的选择，默认：轮询调度算法
         */
        private String loadBalancer = DisLockConsts.ROUND_ROBIN_LOAD_BALANCER;
        /**
    ...
    public static class ReplicatedConfig {
         ...
         * 订阅操作的负载均衡模式
         */
        private String subscriptionMode = DisLockConsts.SLAVE;
        /**
         * 负载均衡算法类的选择，默认：轮询调度算法
         */
        private String loadBalancer = DisLockConsts.ROUND_ROBIN_LOAD_BALANCER;
