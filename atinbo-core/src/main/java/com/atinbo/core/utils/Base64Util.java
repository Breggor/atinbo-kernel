...
public class Base64Util extends org.springframework.util.Base64Utils {
	...
	public static String encode(String value) {
		return Base64Util.encode(value, Charsets.CHARSET_UTF_8);
	}
	...
	public static String encodeUrlSafe(String value) {
		return Base64Util.encodeUrlSafe(value, Charsets.CHARSET_UTF_8);
	}
	...
	public static String decode(String value) {
		return Base64Util.decode(value, Charsets.CHARSET_UTF_8);
	}
	...
	public static String decodeUrlSafe(String value) {
		return Base64Util.decodeUrlSafe(value, Charsets.CHARSET_UTF_8);
	}
