...
import com.atinbo.core.support.ImagePosition;
import com.atinbo.core.support.MultiOutputStream;
...
public final class ImageUtil {
     ...
     */
    public final static void sliceWithNumber(BufferedImage src, MultiOutputStream mos, String type, int prows, int pcols) {
        try {
     ...
     */
    public final static void sliceWithSize(BufferedImage src, MultiOutputStream mos, String type, int pdestWidth, int pdestHeight) {
        try {
