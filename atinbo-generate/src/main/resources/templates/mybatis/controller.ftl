...
public Outcome
<Pageable
<${classInfo.className}VO>> findPage(@Validated @ApiParam("${classInfo.classComment}查询参数") ${classInfo.className}QueryForm form, PageForm pageForm) throws HttpApiException {
    Outcome
    <Pageable
    <${classInfo.className}BO>> outcome = ${classInfo.className?uncap_first}Service.pageList(${classInfo.className}Mapper.INSTANCE.to${classInfo.className}Param(form),
        ...
        */
        ...
        @GetMapping("/{id}")
        public Outcome
        <${classInfo.className}VO> findById(@PathVariable("id") @Validated @ApiParam("${classInfo.primaryField.fieldComment}") ${classInfo.primaryField.fieldClass} id) throws HttpApiException {
            Outcome
            <${classInfo.className}BO> outcome = ${classInfo.className?uncap_first}Service.findById(id);
                if (outcome.ok()) {
                ...
                */
                ...
                Outcome
                <${classInfo.className}BO> outcome = ${classInfo.className?uncap_first}Service.save(${classInfo.className}Mapper.INSTANCE.to${classInfo.className}Param(form));
                    if (outcome.ok()) {
