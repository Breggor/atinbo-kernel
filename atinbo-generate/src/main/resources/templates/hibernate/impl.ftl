...
<${classInfo.className}BO> save(${classInfo.className}Param ${classInfo.className?uncap_first}Param) {
    ${classInfo.className} ${classInfo.className?uncap_first} = ${classInfo.className?uncap_first}Repository.saveAndFlush(${classInfo.className}Mapper.INSTANCE.to${classInfo.className}
    (${classInfo.className?uncap_first}Param));
    ...
    */
    ...
    <${classInfo.className}BO> findById(${classInfo.primaryField.fieldClass} id) {
        ...
        */
        ...
        public Outcome
        <List
        <${classInfo.className}BO>> pageList(${classInfo.className}Param ${classInfo.className?uncap_first}Param, PageParam pageParam){
            ...
            List
            <${classInfo.className}BO> ${classInfo.className?uncap_first}Bos = ${classInfo.className}Mapper.INSTANCE.to${classInfo.className}Bos(page.getContent());
                return Outcome.ofSuccess(PageUtil.toPagination(page), ${classInfo.className?uncap_first}Bos);
                }
                }