...
public final class Inflector {
   ...
   * </pre>
   *
   * @param word the string to pluralize
   ...
   * </pre>
   *
   * @param word the string to singularize
   ...
   * @param lower whether to create lower camel case
   ...
   *
   * <p>It uses {@link Normalizer#normalize(CharSequence, Form)} with {@link
   * Form#NFD} normalization and then replaces accented characters with their equivalent unaccented
   * characters.
   *
